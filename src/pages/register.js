...
const Register = () => {
  ...
  return (
    ...
    >
     ...
     style={{ backgroundImage: "url('/backgroundd.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
...
<form onSubmit={handleSubmit} className="space-y-6 w-full max-w-lg p-8 border-black border-top">
  {/* Name */}
 <h1 className="text-3xl font-bold mb-2 justify-center flex">
    <span className="text-black">Welcome to </span>
    <span className="text-red-700 ml-2">Optichain</span>
  </h1>
  <p className="text-xl font-bold text-black mb-4 justify-center flex">Sign Up</p>
  {message && (
