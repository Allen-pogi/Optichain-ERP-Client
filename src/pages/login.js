  ...
  return (
    ...
    >
      ...
      <div className="flex bg-white  shadow-lg border-black rounded-xl p-0 w-full max-w-5xl z-10">
        {/* Logo Section */}
       <div className="flex flex-col justify-center items-center w-1/2 p-8 border-r border-gray-200 rounded-l-xl"
...
<form onSubmit={handleSubmit} className="space-y-8 w-full max-w-lg p-8 border-black border-top">
  {/* Name */}
  <h1 className="text-3xl font-bold text-red-700 mb-2 justify-center flex"><span className="text-black">Welcome to </span>
    <span className="text-red-700 ml-2">Optichain</span> </h1>
  <p className="text-xl font-bold text-black mb-4 justify-center flex">Log In</p>
  {message && (
