...
const AdminPanel = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      setAdminName(`${storedUser.firstname} ${storedUser.lastname}`);
    }
  }, []);
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Search "
                className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300 text-sm"
              />
              <span className="absolute right-3 top-2 text-gray-400 material-icons text-base">
                search
              </span>
            </div>
          </div>
